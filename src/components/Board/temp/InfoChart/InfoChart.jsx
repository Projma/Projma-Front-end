...
const InfoChart = (props) => {
  ...
  const style = {
    ...
    bgcolor: theme.minorBg, // #5090D3 #1E4976 #265D97 CEE0F3
  ...
  useEffect(() => {
    apiInstance
      .get(`/board/chart/${props.boardId}/board-members-activity/`)
      .then((res) => {
  ...
  useEffect(() => {
    apiInstance
      .get(`/board/chart/${props.boardId}/board-tasklists-activity/`)
      .then((res) => {
  ...
  useEffect(() => {
    apiInstance
      .get(`/board/chart/${props.boardId}/board-label-activity/`)
      .then((res) => {
        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            >
              ...
              <Divider
                sx={{ width: "100%", marginTop: "5%", bgcolor: theme.secondary }}
              />
              <Typography
                id="spring-modal-title"
                variant="h6"
